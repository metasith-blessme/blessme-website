...
export const FAQS_EN = [
  ...
  { q: 'How long is the shelf life?', a: 'Twelve months unopened, stored cool and dry. Once opened, refrigerate and use within 1 month for best texture.' },
  ...
  { q: 'What is the minimum order for BlessMe popping boba?', a: 'No strict minimum order. Single packs at 115 THB each (500g, ~20 servings). Full box of 24 packs at 80 THB/pack for best wholesale pricing. Both options ship nationwide across Thailand.' },

  { q: 'What makes BlessMe popping boba different from other suppliers?', a: 'BlessMe specializes in Thai-inspired flavors unavailable from other suppliers: Barley, Red Bean, and Oat — alongside Water Chestnut, Osmanthus, and Moji Yogurt. All flavors use seaweed-derived shells (not gelatin) filled with real fruit juice. Bangkok local stock means fast delivery with no import delays.' },
  { q: 'How much does popping boba wholesale cost in Thailand?', a: 'BlessMe wholesale pricing: 115 THB per 500g pack (single order), or 80 THB per pack when ordering a full box of 24 packs (1,920 THB/box). Each pack yields approximately 20 servings at 15g each. Contact us for volume pricing on larger orders.' },
  { q: 'Can I get free samples of BlessMe popping boba before ordering?', a: 'Yes. Contact BlessMe at Blessme.team@gmail.com or LINE: @blessmethailand to request samples. Our B2B team will arrange sample packs for café owners and food businesses evaluating our product range.' },
];
...
export const FAQS_TH = [
  ...
  { q: 'อายุผลิตภัณฑ์นานเท่าไหร่?', a: 'สิบสองเดือนเมื่อยังไม่ได้เปิด เก็บในที่เย็นและแห้ง เมื่อเปิดแล้วให้แช่เย็นและใช้ภายใน 1 เดือน เพื่อเนื้อสัมผัสที่ดีที่สุด' },
  ...
  { q: 'ซื้อป๊อปปิ้งโบบาราคาส่งในกรุงเทพฯ ได้ที่ไหน?', a: 'เบลสมี (ประเทศไทย) จำกัด มีสต็อกป๊อปปิ้งโบบาพรีเมียมในกรุงเทพฯ และจัดส่งทั่วไทย มี 6 รสชาติ: บาร์เลย์ ถั่วแดง ข้าวโอ๊ต แห้วจีน หอบหมื่นลี้ และโมจิโยเกิร์ต ติดต่อที่ Blessme.team@gmail.com หรือ LINE: @blessmethailand' },
  { q: 'สั่งซื้อมุกป๊อปของ BlessMe ขั้นต่ำเท่าไหร่?', a: 'ไม่มีขั้นต่ำที่เข้มงวด ซื้อแพ็คเดี่ยวได้ที่ 115 บาท/แพ็ค (500g ประมาณ 20 ที่เสิร์ฟ) หรือยกลัง 24 แพ็คที่ 80 บาท/แพ็ค เพื่อราคาส่งที่ดีที่สุด จัดส่งทั่วไทย' },

  { q: 'มุกป๊อปของ BlessMe แตกต่างจากซัพพลายเออร์รายอื่นอย่างไร?', a: 'BlessMe เชี่ยวชาญรสชาติแบบไทยที่ซัพพลายเออร์รายอื่นไม่มี: บาร์เลย์ ถั่วแดง และข้าวโอ๊ต พร้อมด้วยแห้วจีน หอบหมื่นลี้ และโมจิโยเกิร์ต ทุกรสชาติใช้เปลือกสาหร่ายธรรมชาติ (ไม่ใช่เจลาติน) บรรจุน้ำผลไม้แท้ สต็อกอยู่ในกรุงเทพฯ ส่งเร็วไม่ต้องรอนำเข้า' },
  { q: 'ป๊อปปิ้งโบบาราคาส่งในไทยราคาเท่าไหร่?', a: 'ราคาส่งของ BlessMe: 115 บาท/แพ็ค 500g (ซื้อแพ็คเดี่ยว) หรือ 80 บาท/แพ็คเมื่อสั่งยกลัง 24 แพ็ค (1,920 บาท/ลัง) แต่ละแพ็คได้ประมาณ 20 ที่เสิร์ฟที่ 15g/ที่ ติดต่อสอบถามราคาสำหรับออเดอร์ขนาดใหญ่' },
...
export const WHOLESALE_FAQS_TH = [
  { q: 'ไข่มุกป๊อป (มุกป๊อป) ราคาส่งเท่าไหร่?', a: 'ราคาส่งของ BlessMe: 115 บาท/แพ็ค 500g สำหรับซื้อแพ็คเดี่ยว หรือ 80 บาท/แพ็คเมื่อสั่งยกลัง 24 แพ็ค แต่ละแพ็คได้ประมาณ 20 ที่เสิร์ฟ เท่ากับต้นทุนต่อแก้วเพียง 4–7 บาท' },
