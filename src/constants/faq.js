...
export const FAQS_TH = [
  ...
  { q: 'ซื้อป็อปปิ่งโบบาราคาส่งในกรุงเทพฯ ได้ที่ไหน?', a: 'เบลสมี (ประเทศไทย) จำกัด มีสต็อกป็อปปิ่งโบบาพรีเมียมในกรุงเทพฯ และจัดส่งทั่วไทย มี 6 รสชาติ: บาร์เลย์ ถั่วแดง ข้าวโอ๊ต แห้วจีน หอบหมื่นลี้ และโมจิโยเกิร์ต ติดต่อที่ Blessme.team@gmail.com หรือ LINE: @blessmethailand' },
