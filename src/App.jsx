...
function SolutionsPage({ setPage, lang }) {
  ...
  const stepsTh = [
    { n: '01', t: 'ความต้องการของลูกค้า', d: 'ลูกค้าของเรากำลังมองหาประสบการณ์ใหม่ — จุดแตกต่างที่แท้จริง เราเริ่มต้นทุกการมีส่วนร่วมตั้งแต่ไอเดีย' },
    { n: '02', t: 'การค้นคว้า', d: 'ปัจจุบันยังไม่มีการใช้ผลิตภัณฑ์นี้ในประเทศไทย เราทำแผนผังหมวดหมู่ ศึกษาพฤติกรรมผู้บริโภค และระบุช่องว่างที่พาร์ทเนอร์ของเราสามารถครอบครองได้' },
    { n: '03', t: 'การจัดหา', d: 'เราเป็นเป็นพาร์ทเนอร์กับโรงงานที่น่าเชื่อถือเพื่อส่งมอบสินค้าที่ดีที่สุด ทั้งราคา คุณภาพ และมาตรฐานความปลอดภัยด้านอาหาร — ตรวจสอบอย่างต่อเนื่อง' },
    { n: '04', t: 'การทดสอบ', d: 'เราทดสอบผลิตภัณฑ์กับพาร์ทเนอร์และผู้บริโภค ทุกผลิตภัณฑ์ผ่านฟีดแบ็กหลายรอบก่อนได้รับการอนุมัติให้เข้าแคตตาล็อก' },
    { n: '05', t: 'สต็อก', d: 'เรารักษาสต็อกที่สม่ำเสมอในคลังสินค้ากรุงเทพฯ เพื่อให้พาร์ทเนอร์ไม่หยุดชะงัก สินค้าคงคลังที่ขับเคลื่อนด้วยการพยากรณ์ ช่วยปกป้องกำหนดการเปิดตัวและการสั่งซื้อซ้ำ' },
