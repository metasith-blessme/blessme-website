...
const T = {
  ...
  th: {
    ...
    heroEyebrow: 'เบลสมี (ประเทศไทย) · ผู้จัดหาและจำหน่ายผลิตแต่งหน้าเครื่องดื่มและของหวาน',
    heroTitle: ['นำ', 'ประสบการณ์ใหม่', ' มาสู่เมนูของคุณ'],
    heroSub: 'เราช่วยคิด ค้นหา และจัดส่งผลิตภัณฑ์สึดพิเศษที่ให้พาร์ทเนอร์ของเรามีจุดแตกต่างที่แท้จริง — สินค้าที่ลูกค้าหาไม่ได้ที่อื่นในตลาด',
